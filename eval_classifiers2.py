...
print(f"Logistic Regression  (Sepal Length/Width) - Classification accuracy on testset: {acclc:.2f}")
print(f"Linear Discriminant Analysis ( (Sepal Length/Width) - Classification accuracy on testset: {accld:.2f}")
